...
BUILD_DIR="$PROJECT_DIR/.build/audio-analyzer-test"
MODULE_CACHE_DIR="$PROJECT_DIR/.build/audio-analyzer-test-module-cache"
...
swiftc \
    ...
    "$PROJECT_DIR/Tests/AudioAnalyzerSmokeTest.swift" \
    -o "$BUILD_DIR/AudioAnalyzerSmokeTest"

"$BUILD_DIR/AudioAnalyzerSmokeTest"
